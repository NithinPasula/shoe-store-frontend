      ...
      <Wrapper className="h-[60px] flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 text-black">
          ...
          >
            ...
            <div className="h-[14px] md:h-[18px] min-w-[14px] md:min-w-[18px] rounded-full bg-red-600 absolute top-1 left-7 text-white text-[10px] md:text-[12px] flex justify-center items-center px-[2px] md:px-[5px]">
              51
            </div>
          </div>
          {/* Icon End*/}
